                        ...
                        <div class="panel-box">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" aria-describedby="config table">
                                    <thead>
                                        <tr>
                                            <th style="width: 5px;" scope="col">S.N</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form method="post" action="{{ url($indexUrl . '/' . $item->id) }}"
                                                        class="myForm" id="form{{ $item->id }}"
                                                        enctype="multipart/form-data">
                                                        @csrf
                                                        @method('PUT')
                                                        @if ($item->isTextArea($item->type))
                                                            <textarea name='{{ $inputName }}' class='form-control' onchange="submit()">{{ $item->value }}</textarea>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading no-bdr">
                            <form method="post" class="form-inline" action="{{ url($indexUrl) }}"
                                ...
                                <div id="dynamic-field-wrapper" class="d-none m-3">
                                    <x-system.form.form-inline-group :input="[
                                        'name' => 'value',
                                        'id' => 'text-value',
                                        'label' => 'Value',
