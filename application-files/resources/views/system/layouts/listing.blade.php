            ...
            <div class="modal-dialog" role="document">
                <form id="statusForm" method="GET" action="">
                    <div class="modal-content">
                        @csrf
                        <div class="modal-header">
                            <h5 class="modal-title" id="statusChangeModal">Confirm Update</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                            </button>
                        </div>
                        <div class="modal-body message-body">
                            <strong>Are you sure you want to update status?</strong>
                        </div>
                        <div class="modal-footer">
                            <a type="button" href="{{ $indexUrl }}" class="btn btn-sm btn-secondary"
                                data-dismiss="modal">
                                <em class="glyph-icon icon-close"></em>
                                 Cancel
                            </a>
