...
if ($('#pageWrapper').hasClass('compact-wrapper')) {
    ...
    jQuery('.sidebar-title').click(function () {
        // Reset all icons to fa-angle-right
        jQuery('.sidebar-title').not(this).find('.according-menu i').removeClass('fa-angle-down').addClass('fa-angle-right');

        // Slide up all submenus
        jQuery('.sidebar-submenu, .menu-content').slideUp('normal');
        jQuery('.menu-content').slideUp('normal');

        var $icon = jQuery(this).find('.according-menu i');
